...
- **VPS-FastSearch >= 0.3.1** (includes critical memory and FTS5 fixes)
...
- Ensure VPS-FastSearch >= 0.3.1 with the `threads=2` fix
...
- Ensure VPS-FastSearch >= 0.3.1 with FTS5 query sanitization
